...
const g = '{"title":"Webpack-03 \u591A\u9875\u9762\u3001source-map\u3001\u5B9E\u65F6\u6253\u5305","description":"","frontmatter":{},"headers":[{"level":2,"title":"\u4E00\u3001\u6253\u5305\u591A\u9875\u9762\u5E94\u7528","slug":"\u4E00\u3001\u6253\u5305\u591A\u9875\u9762\u5E94\u7528"},{"level":2,"title":"\u4E8C\u3001\u914D\u7F6Esource-map","slug":"\u4E8C\u3001\u914D\u7F6Esource-map"},{"level":2,"title":"\u4E09\u3001\u5B9E\u65F6\u6253\u5305","slug":"\u4E09\u3001\u5B9E\u65F6\u6253\u5305"},{"level":2,"title":"\u56DB\u3001webpack\u5C0F\u63D2\u4EF6","slug":"\u56DB\u3001webpack\u5C0F\u63D2\u4EF6"},{"level":2,"title":"\u4E94\u3001webpack\u8DE8\u57DF\u95EE\u9898","slug":"\u4E94\u3001webpack\u8DE8\u57DF\u95EE\u9898"},{"level":2,"title":"\u516D\u3001resolve","slug":"\u516D\u3001resolve"},{"level":2,"title":"\u4E03\u3001\u5B9A\u4E49\u73AF\u5883\u53D8\u91CF","slug":"\u4E03\u3001\u5B9A\u4E49\u73AF\u5883\u53D8\u91CF"},{"level":2,"title":"\u516B\u3001\u6307\u5B9A\u8FD0\u884C\u65F6\u7684\u73AF\u5883\u53D8\u91CF","slug":"\u516B\u3001\u6307\u5B9A\u8FD0\u884C\u65F6\u7684\u73AF\u5883\u53D8\u91CF"}],"relativePath":"src/frontend/Webpack/webpack-03 \u591A\u9875\u9762\u3001source-map\u3001\u5B9E\u65F6\u6253\u5305.md","lastUpdated":1615699077000}',
  t = {},
  e = p(`<h1 id="webpack-03-\u591A\u9875\u9762\u3001source-map\u3001\u5B9E\u65F6\u6253\u5305" tabindex="-1">Webpack-03 \u591A\u9875\u9762\u3001source-map\u3001\u5B9E\u65F6\u6253\u5305 <a class="header-anchor" href="#webpack-03-\u591A\u9875\u9762\u3001source-map\u3001\u5B9E\u65F6\u6253\u5305" aria-hidden="true">#</a></h1><h2 id="\u4E00\u3001\u6253\u5305\u591A\u9875\u9762\u5E94\u7528" tabindex="-1">\u4E00\u3001\u6253\u5305\u591A\u9875\u9762\u5E94\u7528 <a class="header-anchor" href="#\u4E00\u3001\u6253\u5305\u591A\u9875\u9762\u5E94\u7528" aria-hidden="true">#</a></h2><div class="language-js"><pre><code><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
    ...
    <span class="token literal-property property">plugins</span><span class="token operator">:</span> <span class="token punctuation">[</span>
        <span class="token keyword">new</span> <span class="token class-name">HtmlWebpackPlugin</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
            ...
            <span class="token literal-property property">chunks</span><span class="token operator">:</span> <span class="token punctuation">[</span><span class="token string">&#39;home&#39;</span><span class="token punctuation">]</span>  <span class="token comment">//\u4EE3\u7801\u5757,\u653Ehome js\u6587\u4EF6</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="\u4E8C\u3001\u914D\u7F6Esource-map" tabindex="-1">\u4E8C\u3001\u914D\u7F6Esource-map <a class="header-anchor" href="#\u4E8C\u3001\u914D\u7F6Esource-map" aria-hidden="true">#</a></h2><ol><li>\u5F53\u4E3Aproduction\u751F\u4EA7\u6A21\u5F0F\u65F6\uFF0C\u4EE3\u7801\u4F1A\u88AB\u538B\u7F29\u6210\u4E00\u884C\uFF0C\u6211\u4EEC\u65E0\u6CD5\u8FDB\u884C\u8C03\u8BD5\uFF0C\u56E0\u6B64\u53EF\u4EE5\u5BF9source-map\u8FDB\u884C\u914D\u7F6E</li></ol><div class="language-js"><pre><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="\u4E09\u3001\u5B9E\u65F6\u6253\u5305" tabindex="-1">\u4E09\u3001\u5B9E\u65F6\u6253\u5305 <a class="header-anchor" href="#\u4E09\u3001\u5B9E\u65F6\u6253\u5305" aria-hidden="true">#</a></h2><p>\u5F53\u6BCF\u6B21\u4FEE\u6539\u6587\u4EF6\u4E4B\u540E\uFF0C\u5C31\u4F1A\u81EA\u52A8\u8FDB\u884C\u4EE3\u7801\u6253\u5305npm run build\uFF0C \u53EA\u9700\u8981\u8FD0\u884C\u4E00\u7BC7npm run build\uFF0C\u5C31\u4F1A\u4E00\u76F4\u5728\u7EC8\u7AEF\u7B49\u5F85\u4EE3\u7801\u66F4\u6539\uFF0C\u5E76\u5B9E\u65F6\u8FDB\u884C\u6253\u5305</p><div class="language-js"><pre><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
    ...
    <span class="token literal-property property">watchOptions</span><span class="token operator">:</span> <span class="token punctuation">{</span> <span class="token comment">// \u76D1\u63A7\u9009\u9879</span>
        <span class="token literal-property property">poll</span><span class="token operator">:</span> <span class="token number">1000</span><span class="token punctuation">,</span> <span class="token comment">// \u6BCF\u79D2\u95EE\u62111000\u6B21</span>
        <span class="token literal-property property">aggregateTimeout</span><span class="token operator">:</span> <span class="token number">500</span><span class="token punctuation">,</span> <span class="token comment">// \u9632\u6296\u529F\u80FD, 500\u6BEB\u79D2\u53EA\u6253\u5305\u4E00\u6B21</span>
        <span class="token literal-property property">ignored</span><span class="token operator">:</span> <span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">node_modules</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">,</span>  <span class="token comment">// \u5FFD\u7565\u6587\u4EF6\u4E0D\u76D1\u63A7</span>
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="\u56DB\u3001webpack\u5C0F\u63D2\u4EF6" tabindex="-1">\u56DB\u3001webpack\u5C0F\u63D2\u4EF6 <a class="header-anchor" href="#\u56DB\u3001webpack\u5C0F\u63D2\u4EF6" aria-hidden="true">#</a></h2><ol><li>\u6BCF\u6B21\u6253\u5305\u5220\u9664dist\u76EE\u5F55</li></ol><p>\u5B89\u88C5\uFF1Ayarn add clean-webpack-plugin -D</p><div class="language-js"><pre><code><span class="token keyword">const</span> CleanWebpackPlugin <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;clean-webpack-plugin&#39;</span><span class="token punctuation">)</span>
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">plugins</span><span class="token operator">:</span> <span class="token punctuation">[</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="\u4E94\u3001webpack\u8DE8\u57DF\u95EE\u9898" tabindex="-1">\u4E94\u3001webpack\u8DE8\u57DF\u95EE\u9898 <a class="header-anchor" href="#\u4E94\u3001webpack\u8DE8\u57DF\u95EE\u9898" aria-hidden="true">#</a></h2><p>webpack\u7531\u4E8E\u5185\u7F6E\u542F\u52A8\u4E86\u4E00\u4E2A\u670D\u52A1\uFF0C\u56E0\u6B64\u9ED8\u8BA4\u5B89\u88C5\u4E86express\uFF0C\u53EF\u4EE5\u76F4\u63A5\u4F7F\u7528express</p><div class="language-js"><pre><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre></div><p>\u5F53\u542F\u52A8node server.js\u4F1A\u540C\u65F6\u542F\u52A8webpack</p><h2 id="\u516D\u3001resolve" tabindex="-1">\u516D\u3001resolve <a class="header-anchor" href="#\u516D\u3001resolve" aria-hidden="true">#</a></h2><div class="language-js"><pre><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">resolve</span><span class="token operator">:</span> <span class="token punctuation">{</span> <span class="token comment">// \u89E3\u6790\u7B2C\u4E09\u65B9\u6A21\u5757</span>
        ...
        <span class="token literal-property property">alias</span><span class="token operator">:</span> <span class="token punctuation">{</span> <span class="token comment">// \u522B\u540D, \u89E3\u51B3\u5F15\u5165\u5730\u5740\u592A\u957F</span>
            
        <span class="token punctuation">}</span><span class="token punctuation">,</span>
        <span class="token literal-property property">mainFields</span><span class="token operator">:</span> <span class="token punctuation">[</span><span class="token string">&#39;style&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;main&#39;</span><span class="token punctuation">]</span> <span class="token comment">// \u5148\u67E5\u627Estyle\u5B57\u6BB5, \u518D\u67E5\u627Emain</span>
...
<span class="token punctuation">}</span> <span class="token keyword">else</span> <span class="token punctuation">{</span>
    url <span class="token operator">=</span> <span class="token string">&#39;http://wing.vip&#39;</span>
<span class="token punctuation">}</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre></div><p>\u5F53\u5F00\u53D1\u65F6\u9700\u8981\u6307\u5B9Aconfig\u6587\u4EF6\uFF1A npm run start -- --config webpack.dev.js \u4E2D\u95F4\u4E24\u4E2A\u6760\u6307\u4F20\u53C2</p><h2 id="\u516B\u3001\u6307\u5B9A\u8FD0\u884C\u65F6\u7684\u73AF\u5883\u53D8\u91CF" tabindex="-1">\u516B\u3001\u6307\u5B9A\u8FD0\u884C\u65F6\u7684\u73AF\u5883\u53D8\u91CF <a class="header-anchor" href="#\u516B\u3001\u6307\u5B9A\u8FD0\u884C\u65F6\u7684\u73AF\u5883\u53D8\u91CF" aria-hidden="true">#</a></h2><ol><li><p>\u5B89\u88C5\u63D2\u4EF6\uFF1A<code>npm install cross-env</code></p></li><li><p>\u5728<code>package.json</code>\u6587\u4EF6\u914D\u7F6E</p><div class="language-json"><pre><code><span class="token property">&quot;start&quot;</span><span class="token operator">:</span> <span class="token string">&quot;cross-env NODE_ENV=development webpack&quot;</span>
</code></pre></div></li><li><p>\u4E4B\u540E\u5728\u6587\u4EF6\u4E2D\u53D6\uFF1A<code>process.<wbr>env.NODE_ENV</code></p></li></ol>`, 43),
  o = [e];

function c(l, r, u, k, i, d) {
